...
{   
    ...
    Eigen::Vector3f r1 = ab.cross(ap);
    Eigen::Vector3f r2 = bc.cross(bp);
    Eigen::Vector3f r3 = ca.cross(cp);

    if((r1.z()>0&&r2.z()>0&&r3.z()>0) || (r1.z()<0&&r2.z()<0&&r3.z()))
        return true;
    else
        return false;
}
